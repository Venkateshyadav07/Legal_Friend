...
st.set_page_config(page_title="Legal Friend", layout="centered")
...
api_key = '0b7814157324023d6d1ab54b323a0618853495167b8ab7a53b27a6b8174ce874'
...
input_prompt = st.chat_input("Say Your Query...")
if input_prompt:
